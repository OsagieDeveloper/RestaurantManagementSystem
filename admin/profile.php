<?php
  ...
  $adminEmail = isset($_SESSION['email']) ? $_SESSION['email'] : 'N/A';
  ...
  if (isset($_POST['save_changes'])) {
    ...
    $adminFullName = secureData($_POST['full_name']);
    
    $stmt = $mysqli->prepare("UPDATE admin SET full_name = ? WHERE email = ?");
    $stmt->bind_param("ss", $adminFullName, $adminEmail);
    $stmt->execute();
...
<body>
    <div class="container">
        ...
        <main>
          <h2  style="font-size: 48px; font-weight: bold; font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif;" class="section__header">admin Profile</h2>
          <div class="profile__card">
            ...
            <div class="profile__details">
              <h3><?php echo htmlspecialchars($adminFullName); ?></h3>
          ...
          <div class="edit__form__container" id="editFormContainer" style="display: none;">
            ...
            <form method="POST" action="">
              <div class="form__group">
                ...
                <input type="text" id="full_name" name="full_name" value="<?php echo htmlspecialchars($adminFullName); ?>" required>
              </div>
              <div class="form__group">
                <label for="phone">Phone Number:</label>
                <input type="tel" id="phone" name="phone" value="<?php echo htmlspecialchars($adminPhone); ?>">
              </div>
              <div class="form__group">
                <label for="address">Address:</label>
                <textarea id="address" name="address" rows="3"><?php echo htmlspecialchars($adminAddress); ?></textarea>
              </div>
